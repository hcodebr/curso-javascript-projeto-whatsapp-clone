...
export class Message extends Model {
	...
	// Mostra a mensagem de acordo com seu tipo
	getViewElement(me = true){
        ...
        if (me) {
            ...
            // coloca o status como irmão do message-time
    ...
    static sendImage(chatId, from, file){
        ...
        return new Promise((s,f) => {
            ...
            // put é pra colocar o blob no banco
            ...
            uploadTask.on('state_changed', e => {
                ...
                console.log('uploadTask.snapshot.downloadURL: ',uploadTask.snapshot.downloadURL);
    ...
    static send(chatId, from, type, content){
        ...
        return new Promise((s,f) => {
            ...
            Message.getRef(chatId).add({
                ...
                // Vai no documento pai e procura o result.id, ou seja o id da mensagem que acabou de ser inserida, e muda o status para enviada
                result.parent.doc(result.id).set({
                    status: 'sent'
                }, {
                    merge: true // as demais informações continuam
                }).then(()=>{
                    s();
                });
